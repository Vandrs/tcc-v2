			...
			<div class="col-xs-12 col-sm-4 col-md-3 margin-top-10">
				<div class="user-card box" data-user-id="{{$user->id}}">
					...
					<div class="user-card-controls text-right">
						...
						<button class="btn btn-fab btn-fab-mini show-invite-modal" title="Convidar para o Projeto" data-user-id="{{$user->id}}" data-user-name="{{$user->name}}" data-toggle="tooltip">
